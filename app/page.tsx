  ...
  return (
    <section className="relative min-h-[calc(100vh-7rem)] overflow-hidden py-4 sm:py-10">
      <Image
        ...
        width={720}
        height={720}
        className="pointer-events-none absolute left-1/2 top-0 h-64 w-64 -translate-x-1/2 object-contain sm:left-auto sm:right-0 sm:top-[42%] sm:h-[34rem] sm:w-[34rem] sm:translate-x-0 sm:-translate-y-1/2"
        priority
      />

      <div className="relative z-10 max-w-2xl pt-64 sm:max-w-[55%] sm:pt-10">
        ...
        <p className="mt-5 max-w-2xl text-lg text-ink/75">
          Compra o vende Bitcoin con Mostro desde tu navegador local. Mostrico usa tu instalación de <code>mostro-cli</code>, no pide mnemonic y no mueve dinero por ti.
        </p>
      ...
      <div className="relative z-10 mt-14 border-t border-line/70 pt-6 sm:mt-20 sm:max-w-4xl">
